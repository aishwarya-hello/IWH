...
public class MainActivityNews extends AppCompatActivity {
    ...
    String API_KEY = "82bf8721f40d497391b22f10be1bbe1c"; // ### YOUE NEWS API HERE ###
    ...
    class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String xml) {
            ...
            if(xml.length()>10){ // Just checking if not empty
                ...
                ListNewsAdapter adapter = new ListNewsAdapter(MainActivityNews.this, dataList);
                listNews.setAdapter(adapter);

                listNews.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> parent, View view,
                                            int position, long id) {
                        Intent i = new Intent(MainActivityNews.this, DetailsActivity.class);
